import { SystemSettingDetailActions } from "@/app/dashboard/system-settings/[key]/system-setting-detail-actions";
      ...
      <DetailPageLayout
        ...
        header={
          <PageHeader
            ...
            title={def.label}
            back={{ href: "/dashboard/system-settings", label: "Back to system settings" }}
