...
import { Card, CardBody, ListViewLayout, Stack } from "@adrikesteren/adricore/blocks";
        ...
        <Stack gap="lg">
          ...
          <Card>
            <CardBody>
              ...
              <p className="bk-text-muted bk-stack bk-stack_gap-sm text-sm" style={{ marginBottom: "0.75rem" }}>
                Live USD snapshot (market cap, volume, price, etc.) on assets that already have a coin id â€” resolve phase
